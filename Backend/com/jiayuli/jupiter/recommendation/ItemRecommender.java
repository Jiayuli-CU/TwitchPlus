package com.jiayuli.jupiter.recommendation;
...
import com.jiayuli.jupiter.external.TwitchException;
...
public class ItemRecommender {
    ...
    // Return a list of Item objects for the given type. Types are one of [Stream, Video, Clip].
    // All items are related to the items previously favorited by the user. E.g., if a user favorited some videos
    // about game "Just Chatting", then it will return some other videos about the same game.
